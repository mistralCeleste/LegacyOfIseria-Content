...
--
-- Returns:
-- Tracks the item and puts it back on cleanup.
--
-- Example:
-- Items removed from the bag when the player selects,
-- "cleanup" will be placed back in the bag.
-----------------------------------------
...
function onObjectEnterContainer(container, object)
    ...
    if object.tag == "Bag" and SHUFFLE_ON_ADD then
        object.shuffle()
    end
